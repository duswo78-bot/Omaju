...
온디바이스 AI는 기기 capability에 따라 자동 선택됩니다.

| 경로 | 역할 | S25 | S26 |
|------|------|-----|-----|
| Brain (임베딩+NLU) | 추천 ID | ✅ | ✅ |
| **Rewriting** (AICore) | 답변 말투 | ✅ | ✅ |
| **Prompt** (AICore) | Front intent + Back NLG | ❌ 공식 | ✅ |
| 시스템 STT | 음성 입력 | ✅ | ✅ |

LED: 녹색=온디바이스 GenAI(Prompt 또는 Rewriting), 주황=다운로드 중, 소등=NLU+템플릿만.
