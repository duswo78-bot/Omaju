...
/** @typedef {'soju'|'beer'|'wine'|'makgeolli'|'highball'|'whiskey'|'vodka'|'fruit_wine'|'baijiu'|'sake'|'nonalc'|'other'} DrinkFamily */

/** @type {Record<DrinkFamily, { labels: string[], categories: string[] }>} */
export const DRINK_FAMILIES = {
  soju: {
    labels: [
      '소주', '진로', '참이슬', '화요', '청하', '새로', '좋은데이', '한라산', '이즈백',
      '증류주', '증류식소주', '희석식소주', '처음처럼', '일품진로', '원소주'
    ],
    categories: ['소주'],
  },
  beer: {
    labels: [
      '맥주', '비어', '칭따오', '기네스', '카스', '테라', '켈리', '아사히', '하이네켄', '스텔라', '버드',
      '생맥', '생맥주', '캔맥', '캔맥주', '병맥', '병맥주', '흑맥', '흑맥주', '수제맥주', '라거', '에일', 'ipa', '스타우트', '밀맥주'
    ],
    categories: ['맥주'],
  },
  wine: {
    labels: [
      '와인', '레드와인', '화이트와인', '스파클링', '포트와인',
      '샴페인', '스파클링와인', '로제와인', '로제', '내추럴와인', '뱅쇼', '글루바인'
    ],
    categories: ['와인'],
  },
  makgeolli: {
    labels: [
      '막걸리', '막걸리/전통주', '전통주', '지평', '장수막걸리', '느린마을',
      '동동주', '약주', '탁주', '이화주', '복순도가'
    ],
    categories: ['전통주'],
  },
  highball: {
    labels: [
      '하이볼', '칵테일', '준벅', '피치', '사워', '깔루아',
      '진토닉', '모히또', '마티니', '롱티', '위스키하이볼', '얼그레이하이볼'
    ],
    categories: ['칵테일/하이볼'],
  },
  whiskey: {
  ...
  vodka: {
    labels: ['보드카', '보드카토닉', '앱솔루트', '스미노프'],
    categories: ['보드카'],
  },
  fruit_wine: {
    labels: ['과실주', '복분자', '매실', '매실주', '산사춘'],
    categories: ['과실주'],
  },
  nonalc: {
    labels: ['논알콜', '무알콜', '논알코올', '무알코올', '제로맥주', '무알콜맥주'],
...
export const SNACK_KEY_MAP = {
  국물류: ['국물', '탕', '찌개', '전골', '라면', '우동', '어묵', '오뎅', '짬뽕', '부대찌개'],
  '볶음/구이': ['볶음', '구이', '삼겹', '곱창', '고기', '야키토리', '닭발', '스테이크', '제육'],
  '튀김/전': ['튀김', '전', '치킨', '까스', '가라아게', '타코야키', '파전', '김치전', '모둠전'],
  해산물: ['회', '해산물', '새우', '오징어', '조개', '사시미', '골뱅이', '타코와사비'],
  마른안주: ['마른', '견과', '쥐포', '안주', '먹태', '노가리', '오징어채'],
  '과일/디저트': ['과일', '디저트', '달콤', '치즈', '황도', '샤베트', '빙수', '케이크'],
};
