...
const COMPLEX_TRIGGER_REGEX =
  /(?:말고|빼고|싫어|제외|안\s*먹|안\s*마|안\s*매|덜\s*매|안\s*기름|덜\s*기름|안\s*단|덜\s*단|대신|어제.*오늘|과음|숙취|해장|속\s*쓰|속\s*안|술병|기름진|느끼|담백|얼큰|칼칼|알싸|개운|바삭|달짝|새콤|가볍게|든든|부담|비싼|고급|가성비|2차|3차|막차|퇴근)/;
